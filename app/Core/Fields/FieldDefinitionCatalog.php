    ...
    public static function all(): array
    {
        return [
            ...
            [
                ...
                'scope' => FieldDefinition::SCOPE_COMPANY_USER,
                'label' => 'Gender',
                'translations' => ['en' => 'Gender', 'fr' => 'Sexe'],
                'type' => FieldDefinition::TYPE_SELECT,
                'options' => ['M', 'F'],
                'validation_rules' => ['category' => 'hr', 'applicable_markets' => ['FR']],
                'default_order' => 35,
            ],
            [
                'code' => 'birth_date',
            ...
            [
                ...
                'scope' => FieldDefinition::SCOPE_COMPANY_USER,
                'label' => 'City of Birth',
                'translations' => ['en' => 'City of Birth', 'fr' => 'Commune de naissance'],
                'type' => FieldDefinition::TYPE_STRING,
                'validation_rules' => ['max' => 100, 'category' => 'hr', 'applicable_markets' => ['FR']],
                'default_order' => 42,
            ],
            [
                'code' => 'birth_department',
                'scope' => FieldDefinition::SCOPE_COMPANY_USER,
                'label' => 'Department of Birth',
                'translations' => ['en' => 'Department of Birth', 'fr' => 'Département de naissance'],
                'type' => FieldDefinition::TYPE_STRING,
                'validation_rules' => ['max' => 3, 'category' => 'hr', 'applicable_markets' => ['FR']],
                'default_order' => 43,
            ],
            [
                'code' => 'birth_country',
                ...
                'translations' => ['en' => 'Country of Birth', 'fr' => 'Pays de naissance'],
                'type' => FieldDefinition::TYPE_STRING,
                'validation_rules' => ['max' => 100, 'category' => 'hr', 'applicable_markets' => ['FR']],
                'default_order' => 44,
            ],
            ...
            [
                'code' => 'personal_address_street',
                'scope' => FieldDefinition::SCOPE_COMPANY_USER,
                'label' => 'Personal Address',
                'translations' => ['en' => 'Personal Address', 'fr' => 'Adresse personnelle'],
                'type' => FieldDefinition::TYPE_STRING,
                'validation_rules' => ['max' => 500, 'category' => 'base'],
                'default_order' => 130,
            ],
            [
                'code' => 'personal_address_postal_code',
                'scope' => FieldDefinition::SCOPE_COMPANY_USER,
                'label' => 'Personal Postal Code',
                'translations' => ['en' => 'Personal Postal Code', 'fr' => 'Code postal personnel'],
                'type' => FieldDefinition::TYPE_STRING,
                'validation_rules' => ['max' => 10, 'category' => 'base'],
                'default_order' => 131,
            ],
            [
                'code' => 'personal_address_city',
                'scope' => FieldDefinition::SCOPE_COMPANY_USER,
                'label' => 'Personal City',
                'translations' => ['en' => 'Personal City', 'fr' => 'Ville personnelle'],
                'type' => FieldDefinition::TYPE_STRING,
                'validation_rules' => ['max' => 100, 'category' => 'base'],
                'default_order' => 132,
            ],
            [
                'code' => 'personal_address_country_code',
                'scope' => FieldDefinition::SCOPE_COMPANY_USER,
                'label' => 'Personal Country',
                'translations' => ['en' => 'Personal Country', 'fr' => 'Pays personnel'],
                'type' => FieldDefinition::TYPE_STRING,
                'validation_rules' => ['max' => 2, 'category' => 'base'],
                'default_order' => 133,
            ],
