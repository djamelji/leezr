...
class BillingLastInvoicesWidget implements WidgetManifest
{
    use WidgetLayoutDefaults;

    public function key(): string
    {
        return 'billing.last_invoices';
    }
    ...
    {
        return 'BillingLastInvoices';
    }

    public function tags(): array
    {
        return ['invoices', 'activity', 'billing'];
    }

    public function labelKey(): string
    {
        return 'platformBilling.widgets.lastInvoices';
    }

    public function descriptionKey(): string
    {
        return 'platformBilling.widgets.lastInvoicesDesc';
    }
