...
class ComplianceOverdueWidget implements WidgetManifest
{
    ...
    {
        return ['compliance', 'kpi', 'overdue'];
    }

    public function labelKey(): string
    {
        return 'compliance.widgets.overdue';
    }

    public function descriptionKey(): string
    {
        return 'compliance.widgets.overdueDesc';
    }
