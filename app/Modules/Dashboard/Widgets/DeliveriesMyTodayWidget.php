...
class DeliveriesMyTodayWidget implements WidgetManifest
{
    use WidgetLayoutDefaults;

    public function key(): string
    {
        return 'deliveries.my_today';
    }
    ...
    {
        return 'shipments.widgets.myToday';
    }

    public function descriptionKey(): string
    {
        return 'shipments.widgets.myTodayDesc';
    }
