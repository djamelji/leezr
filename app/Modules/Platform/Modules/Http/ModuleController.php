...
class ModuleController
{
    ...
    public function updateConfig(Request $request, string $key, UpdateModuleConfigUseCase $useCase): JsonResponse
    {
        ...
        $validated = $request->validate([
            'pricing_mode' => ['nullable', 'string', Rule::in(['included', 'addon', 'internal'])],
            'is_listed' => ['required', 'boolean'],
            'is_sellable' => ['required', 'boolean'],
            'pricing_model' => ['nullable', 'string', Rule::in(['flat', 'plan_flat', 'per_seat', 'usage', 'tiered'])],
            'pricing_metric' => ['nullable', 'string', Rule::in(['none', 'users', 'shipments', 'sms', 'api_calls', 'storage_gb'])],
