<script setup>
/**
 * Platform Logs Tab — Extracted from audit/index.vue (platform tab)
 * Pattern: VDataTable with show-expand
 * ADR-381
 */
...
<template>
  <section>
    <VCard>
      ...
      <!-- Pagination -->
      <VCardText
        v-if="auditStore.platformLogsPagination.last_page > 1"
        class="d-flex justify-center"
      >
        <VPagination
          :model-value="auditStore.platformLogsPagination.current_page"
          :length="auditStore.platformLogsPagination.last_page"
