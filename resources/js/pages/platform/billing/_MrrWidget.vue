...
const notSupported = computed(() => props.data?.meta?.not_supported === true)
</script>
    ...
    <div class="widget-body">
      ...
      <template v-else>
        ...
        <div class="widget-subtext text-medium-emphasis">
          {{ t('platformBilling.widgets.mrrDesc') }}
        </div>
      </template>
    </div>
  </div>
