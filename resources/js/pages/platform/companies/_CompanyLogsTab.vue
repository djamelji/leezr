<script setup>
/**
 * Company Logs Tab — Extracted from audit/index.vue (company tab)
...
<template>
  <section>
    <VCard>
      ...
      <!-- Pagination -->
      <VCardText
        v-if="auditStore.companyLogsPagination.last_page > 1"
        class="d-flex justify-center"
      >
        <VPagination
          :model-value="auditStore.companyLogsPagination.current_page"
          :length="auditStore.companyLogsPagination.last_page"
