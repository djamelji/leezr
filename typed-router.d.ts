...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    'platform-languages': RouteRecordInfo<'platform-languages', '/platform/languages', Record<never, never>, Record<never, never>>,
    'platform-login': RouteRecordInfo<'platform-login', '/platform/login', Record<never, never>, Record<never, never>>,
    'platform-markets': RouteRecordInfo<'platform-markets', '/platform/markets', Record<never, never>, Record<never, never>>,
